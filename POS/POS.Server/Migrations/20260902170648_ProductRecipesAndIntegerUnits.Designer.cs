...
namespace POS.Server.Migrations
{
    ...
    [Migration("20260902170648_ProductRecipesAndIntegerUnits")]
    partial class ProductRecipesAndIntegerUnits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POS.Shared.Entities.Dispatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POS.Shared.Entities.DispatchDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DispatchId", "ProductId")
                        .IsUnique();

                    b.ToTable("DETALLE_DESPACHO", null, t =>
                        {
                            t.HasCheckConstraint("CK_DETALLE_DESPACHO_Cantidad", "[Quantity] > 0");
                        });
                });

            modelBuilder.Entity("POS.Shared.Entities.InventoryMovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MOVIMIENTO_INVENTARIO", null, t =>
                        {
                            t.HasCheckConstraint("CK_MOVIMIENTO_INVENTARIO_Cantidad", "[Quantity] > 0");
                        });
                });
            ...
            modelBuilder.Entity("POS.Shared.Entities.ProductRecipeItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RECETA_PRODUCTO", null, t =>
                        {
                            t.HasCheckConstraint("CK_RECETA_PRODUCTO_Cantidad", "[QuantityPerUnit] > 0");
                        });
                });

            modelBuilder.Entity("POS.Shared.Entities.ProductionLot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POS.Shared.Entities.ProductionLotMaterialDetail", b =>
                {
                    ...
                    b.HasIndex("ProductionLotId", "RawMaterialId")
                        .IsUnique();
            ...
            modelBuilder.Entity("POS.Shared.Entities.DispatchDetail", b =>
                {
                    b.HasOne("POS.Shared.Entities.Dispatch", "Dispatch")
                        .WithMany("Details")
                        .HasForeignKey("DispatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("POS.Shared.Entities.InventoryProduct", "Product")
                        .WithMany("DispatchDetails")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("POS.Shared.Entities.ProductionLot", "ProductionLot")
                        .WithMany("DispatchDetails")
